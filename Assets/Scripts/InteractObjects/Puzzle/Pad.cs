...
public class Pad : MonoBehaviour
{
    ...
    {
        if (other.gameObject.GetComponent<InteractPad>() != null) //If a box is placed...
        {
            objectsOnPad++;


            if (other.gameObject.GetComponent<InteractPad>().ReturnInteractPadId() == padId) //If the box has the same number as the pad, then its the correct box...
            {
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.gameObject.GetComponent<InteractPad>() != null) //If it is a box that has stopped colliding...
        {
            objectsOnPad--; //...then reduce the number of colliding objects...
            ColorPadManager.instance.DecreasePlacement();


            if (other.gameObject.GetComponent<InteractPad>().ReturnInteractPadId() == padId) //...If the box that has stopped colliding is the correct box for this pad...
            {
